...
window.addEventListener('DOMContentLoaded', function() {
    ...
    var createScene = function() {
        ...
        scene.clearColor = new BABYLON.Color3(82/255, 102/255, 155/255); // blue color
...
//        var door, sample;
        ...
        BABYLON.SceneLoader.ImportMesh("", "/static/assets/contact_lens_holder/", "contact_lens_holder.gltf", scene, function(newmeshes) {
            ...
            cover = scene.getMeshByName("cover");
            coverInitPosition_Y = cover.position.y
            lens = scene.getMeshByName("lens");
            lensInitPosition_Y = lens.position.y
...
//            sampleInitPosition_X = sample.position.x;
            ...
            header2.text = "Move the contact lens up or down: 0.00 cm";
            header2.height = "40px";
            header2.color = "white";
            ...
            slider2.maximum = 1;
            slider2.value = 0;
            slider2.color = "Crimson"; // HTML color naming convention works here (https://www.w3schools.com/colors/colors_names.asp)
            slider2.height = "15px";
            slider2.width = "200px";
            slider2.isThumbCircle = true;
            slider2.thumbWidth = "12px";
            panel.addControl(slider2);


            var header = new BABYLON.GUI.TextBlock();
            header.text = "Move the top cover up or down: 0.00 cm";
            header.height = "40px";
            header.color = "white";
            ...
            slider.maximum = 2;
            slider.value = 0;
            slider.color = "Crimson"; // HTML color naming convention works here (https://www.w3schools.com/colors/colors_names.asp)
            slider.height = "15px";
            slider.width = "200px";
...
//            panel.addControl(slider2);
            ...
            slider.onValueChangedObservable.add(function(value){
                header.text = "Move the top cover up or down: " + value.toFixed(2) + " cm";
                var y = coverInitPosition_Y + value;
                cover.position.y = y;
            });

            slider2.onValueChangedObservable.add(function(value){
                header2.text = "Move the contact lens up or down: " + value.toFixed(2) + " cm";
                var y = lensInitPosition_Y + value;
                lens.position.y = y;
            });
